        ...
        <span>Your item has been added to Cart!</span>
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pt-5 px-10 mt-[4rem]">
            {womensClothings.map(womensCloth => (
                ...
                <img src={womensCloth.image} alt="" className='rounded-lg cursor-pointer w-[100%] h-[80%]'/>
                    <h2 className="pt-5">{womensCloth.title}</h2>
                    <div className="flex justify-between items-center pt-4">
                    <p className='font-bold'>#{womensCloth.price * 100}</p>
                       <div onClick={() => handleBookmarkClick(womensCloth.id)} className='bg-purple-900 px-4 py-2 rounded flex items-center gap-2 cursor-pointer hover:scale-110 duration-700'>
