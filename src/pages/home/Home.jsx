    ...
    <div className="text bg-white md:pt-[5rem]">
      ...
      <div className="flex flex-col-reverse gap-9 justify-around items-center py-10 px-[1rem] md:px-[5rem] lg:flex-row">
        <div className="w-[80%] lg:w-[40%] text-black text-center md:text-left">
          ...
          <h1 className="font-extrabold text-2xl md:text-3xl py-5">
            {electronics.title}
          </h1>
          <h3 className="pb-5">{electronics.description}</h3>
          <button
            className="px-5 py-3 bg-purple-500 rounded text-white"
      ...
      <dialog id="my_modal_1" className="modal">
        <div className="modal-box text-center bg-white text-black">
          ...
          <p className="uppercase font-bold text-xs mt-2">
      ...
      <div className="py-10 grid grid-cols-2 lg:grid-cols-4 gap-[1.5rem] mt-10 mx-6">
        <div
          ...
          className="max-w-md shadow-md pb-5 rounded h-[90%] cursor-pointer"
        >
        ...
        <div
          ...
          className="shadow-md max-w-md pb-5 rounded h-[90%] cursor-pointer"
        >
          <img
            src={image3}
            alt=""
            className="w-[60%] mx-auto relative -top-7"
          />
          <div className="text-center text-black">
        ...
        <div
          ...
          className="shadow-md max-w-md pb-12 rounded h-[90%] cursor-pointer"
        >
          <img
            src={image2}
            alt=""
            className="w-[26%] mx-auto relative -top-7 rounded-sm"
          />
          <div className="text-center text-black">
        ...
        >
          <img
            src={image6}
            alt=""
            className="w-[22%] mx-auto relative -top-7"
          />
          <div className="text-center text-black">
      ...
      <div>
        <div
          ...
          className="flex flex-col-reverse justify-around items-center py-10 px-0 md:px-[5rem] mx-[2rem] lg:flex-row"
        >
          <div className="w-[100%] lg:w-[60%] px-10 py-5 md:py-20 bg-purple-800 text-white rounded">
            <p className="text-sm">NEW PRODUCT</p>
            <h1 className="font-extrabold text-xl md:text-3xl py-5 rounded">
              {jewelry.title}
            </h1>
          ...
          <img
            src={jewelry.image}
            alt=""
            className="rounded-full w-[50%] lg:w-[25%]"
          />
        </div>
        ...
        <div
          ...
          className="flex flex-col justify-around items-center py-10 px-10 md:px-[5rem] lg:flex-row"
        >
          <img
            src={mens_clothing.image}
            alt=""
            className="w-[50%] rounded-lg lg:w-[30%]"
          />
          <div className="w-[100%]  lg:w-[55%] bg-gray-200 px-10 py-8 md:py-20 rounded">
            <p className="text-sm">NEW PRODUCT</p>
            <h1 className="font-extrabold text-2xl md:text-3xl py-5 text-black">
              {mens_clothing.title}
            </h1>
            <button
              className="px-5 py-3 bg-purple-500 rounded text-white"
        ...
        <div
          ...
          className="flex flex-col-reverse justify-around items-center py-10 px-0 md:px-[5rem] mx-[2rem] rounded lg:flex-row"
        >
          <div className="w-[100%] lg:w-[55%] px-10 py-8 md:py-20 bg-purple-800 text-white rounded">
            <p className="text-sm">NEW PRODUCT</p>
            <h1 className="font-extrabold text-xl md:text-3xl py-5">
              {womens_clothing.title}
            </h1>
            <button
              className="px-5 py-3 bg-purple-500 rounded text-white"
          ...
          <img
            src={womens_clothing.image}
            alt=""
            className="w-[50%] rounded-full lg:w-[30%]"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col justify-between items-center py-10 gap-3 px-[2rem] lg:px-[5rem] md:flex-row">
        <div className="w-[100%] md:w-[50%] text-black text-center md:text-left">
          <h1 className="font-bold text-3xl py-5">
            BRINGING YOU THE <span className="text-purple-500">BEST</span>{" "}
